...
<td>1</td>
<td>포천 비둘기낭 캠핑장</td>
<td onclick="location.href='board5.do'" ><label style="cursor:pointer;">2020 포춘밸리 페스티벌 개최 및 캠핑 프로그램 실시</label></td>
<td>김경복</td>
<td>등록일</td>
<td>조회</td>
...
<td>2</td>
<td>포천 비둘기낭 캠핑장</td>
<td onclick="location.href='board5.do'" ><label style="cursor:pointer;">check</label></td>
<td>김경복</td>
<td>등록일</td>
<td>조회</td>
