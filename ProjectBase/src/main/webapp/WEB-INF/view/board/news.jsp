...
<tr>
<td>57</td>
<td onclick="location.href='board4.do'" ><label style="cursor:pointer;">[캠핑꿀팁] 캠핑매듭, 이것만 알면 99%는 해결!</label></td>
<td>관리자</td>
<td>등록일</td>
<td>조회</td>
...
<tr>
<td>15</td>
<td onclick="location.href='board4.do'" ><label style="cursor:pointer;">check</label></td>
<td>관리자</td>
<td>등록일</td>
<td>조회</td>
